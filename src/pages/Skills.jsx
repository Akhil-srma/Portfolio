...
const skillsData = {
  ...
  concepts: [
    'Data Structure and Algorithms', 'Object-Oriented Programming', 'Compiler', 'Operating System', 'Encryption', 'Decryption', 'Artificial Intelligence',
    'Neural Networks', 'API', 'Cloud Computing',
  ],
};
